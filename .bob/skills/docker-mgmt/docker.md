...
<html>
	...
	<head>
		...
		<title>er.com is for sale | www.oxley.com</title>
				...
				<div class="white-bg">
					<div class="row ">
						<div class="col-md-8 space10 side_border">
							<h3 class="main_title crummer"><a href="https://www.oxley.com" title="www.oxley.com">www.oxley.com</a> > <a href="https://www.oxley.com/search/" title="">Domain overview</a> > er.com</h3>
							
															<h2 class="main_title_h2 space0">er.com</h2>
					...
					<div class="row" id="offer_form">
						<div class="col-md-12 space30">
							...
							<h3 class="main_title text-black space0">er.com</h3>
					...
					<div class="row">
						...
						<form action="ajaxa/landing_themes/add_inquiry_cap/" method="post" class="odf_ajax detail_form" data-target="form_feedback">                                                     			
							...
							<input type="hidden" name="domain_id" value="4644494">  
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" placeholder="Offer (min: USD 2,000,000)" name="offer" class="form-control">
										</div>
									</div>
								</div>
								<div class="row">
...
<script>
	...
	$( document ).ready(function() {
		...
		Odf.ajax.get('https://oxley.com/ajax/visitors/create/', 'div#stats_div', { domain_id: '4644494' });
